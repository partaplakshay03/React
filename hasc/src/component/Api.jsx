  ...
  const [data, setData] = useState([])
    ...
    return (
        <div className='min-h-screen text-white flex flex-col pb-10'>
            {/* top  */}
            <div className='flex justify-between items-center  sm:px-5 md:px-8 lg:px-10 xl:px-15 2xl:px-20'>
            ...
            {/* Product Section */}
            <div className='gap-5 px-2 sm:px-5 md:px-8 lg:px-10 xl:px-15 2xl:px-20 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 py-5'>

                {
                    data.map((item, index) => (
                        <div key={index} className=' rounded-2xl text-black bg-gray-300'>
